...
Binary model checkpoint files are not included in public release assets because serialized model formats can embed build details. They are regenerated by local workflow runs when needed.
...
- public release packaging omits local paths, machine identifiers, and binary checkpoint metadata
